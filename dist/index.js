...
server.tool("tables_get", "Get a Nextcloud Table by ID", { tableId: z.number().describe("Table ID") }, async ({ tableId }) => {
    const result = await nc.getTable(tableId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("tables_create", "Create a new Nextcloud Table", {
...
server.tool("tables_delete", "Delete a Nextcloud Table", { tableId: z.number().describe("Table ID") }, async ({ tableId }) => {
    const result = await nc.deleteTable(tableId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("tables_columns", "List columns of a Nextcloud Table", { tableId: z.number().describe("Table ID") }, async ({ tableId }) => {
    const result = await nc.listColumns(tableId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("tables_rows", "List rows of a Nextcloud Table (simple format)", { tableId: z.number().describe("Table ID") }, async ({ tableId }) => {
    const result = await nc.listRows(tableId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("tables_row_create", "Create a row in a Nextcloud Table", {
...
server.tool("tables_row_update", "Update a row in a Nextcloud Table", {
...
server.tool("tables_row_delete", "Delete a row from a Nextcloud Table", { rowId: z.number().describe("Row ID") }, async ({ rowId }) => {
...
server.tool("deck_board_get", "Get a Deck board with details", { boardId: z.number().describe("Board ID") }, async ({ boardId }) => {
    const result = await nc.getBoard(boardId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("deck_board_create", "Create a new Deck board", {
...
server.tool("deck_board_delete", "Delete a Deck board", { boardId: z.number().describe("Board ID") }, async ({ boardId }) => {
    const result = await nc.deleteBoard(boardId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("deck_stacks_list", "List stacks (columns) of a Deck board, including their cards", { boardId: z.number().describe("Board ID") }, async ({ boardId }) => {
    const result = await nc.listStacks(boardId);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
});
server.tool("deck_stack_create", "Create a stack (column) on a Deck board", {
...
server.tool("deck_stack_delete", "Delete a stack from a Deck board", {
    boardId: z.number().describe("Board ID"),
...
server.tool("deck_card_get", "Get a Deck card with full details", {
    boardId: z.number().describe("Board ID"),
    stackId: z.number().describe("Stack ID"),
...
server.tool("deck_card_create", "Create a card in a Deck stack", {
    boardId: z.number().describe("Board ID"),
    stackId: z.number().describe("Stack ID"),
...
server.tool("deck_card_update", "Update a Deck card", {
    boardId: z.number().describe("Board ID"),
    stackId: z.number().describe("Stack ID"),
    cardId: z.number().describe("Card ID"),
...
server.tool("deck_card_delete", "Delete a Deck card", {
    boardId: z.number().describe("Board ID"),
    stackId: z.number().describe("Stack ID"),
    cardId: z.number().describe("Card ID"),
}, async ({ boardId, stackId, cardId }) => {
...
server.tool("deck_card_move", "Move/reorder a Deck card to another stack", {
    boardId: z.number().describe("Board ID"),
...
server.tool("deck_card_assign_label", "Assign a label to a Deck card", {
    boardId: z.number().describe("Board ID"),
    stackId: z.number().describe("Stack ID"),
    cardId: z.number().describe("Card ID"),
...
server.tool("deck_card_assign_user", "Assign a user to a Deck card", {
    boardId: z.number().describe("Board ID"),
    stackId: z.number().describe("Stack ID"),
    cardId: z.number().describe("Card ID"),
...
server.tool("calendar_events_list", "List events in a Nextcloud calendar. Dates in CalDAV format: 20260101T000000Z", {
...
server.tool("calendar_event_get", "Get a specific calendar event by UID", {
...
server.tool("calendar_event_create", "Create a new calendar event. Use CalDAV date format: 20260326T100000Z", {
...
server.tool("calendar_event_update", "Update an existing calendar event", {
    calendarId: z.string().describe("Calendar ID"),
    eventUid: z.string().describe("Event UID"),
...
server.tool("calendar_event_delete", "Delete a calendar event", {
    calendarId: z.string().describe("Calendar ID"),
    eventUid: z.string().describe("Event UID"),
}, async ({ calendarId, eventUid }) => {
